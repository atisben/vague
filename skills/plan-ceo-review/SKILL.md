...
```bash
export BS_SKILL_NAME="plan-ceo-review"
...
ls -t ~/.bastack/projects/$SLUG/designs/*.md 2>/dev/null | head -3 || echo "NO_DESIGN_DOCS"
...
Save to:
```
~/.bastack/projects/$SLUG/designs/{slug}-{branch}-ceo-{YYYYMMDD}.md
```
