...
```bash
export BS_SKILL_NAME="design-review"
...
```bash
~/.bastack/bin/bs-learnings-log '{"skill":"design-review","type":"pattern","key":"SHORT_KEY","insight":"INSIGHT","confidence":8,"source":"observed","files":["path/to/file"]}'
```
