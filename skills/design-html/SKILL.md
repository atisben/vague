...
```bash
export BS_SKILL_NAME="design-html"
...
ls ~/.bastack/projects/$SLUG/designs/*.html 2>/dev/null | head -5 || echo "NO_SHOTGUN_FILES"
ls ~/.bastack/projects/$SLUG/designs/*.md 2>/dev/null | head -5 || echo "NO_DESIGN_DOCS"
```
...
cp "$OUTPUT_FILE" ~/.bastack/projects/$SLUG/designs/
```
