...
```bash
export BS_SKILL_NAME="investigate"
...
```bash
~/.bastack/bin/bs-learnings-log "{\"skill\":\"investigate\",\"type\":\"pitfall\",\"key\":\"SHORT-KEBAB-KEY\",\"insight\":\"Root cause: [mechanism]. Fix: [what was changed]. Watch for: [where else this can appear].\",\"confidence\":9,\"source\":\"observed\",\"files\":[\"path/to/file\"]}"
```
