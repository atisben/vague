...
```bash
vague observations-log '{"skill":"design-shotgun","type":"correction","issue":"User had to manually ask: WHAT_THEY_SAID","suggestion":"Add this as an explicit step in the skill","principle":"GENERALISABLE_TAKEAWAY","source_skill":"design-shotgun"}'
```
